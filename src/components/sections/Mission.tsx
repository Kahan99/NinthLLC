      ...
      <Container>
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <ScrollReveal
            ...
            textClassName="text-[clamp(1.5rem,6vw,2.5rem)] md:text-[clamp(1.75rem,4vw,3.5rem)] font-medium leading-[1.3] md:leading-[1.2] tracking-tight text-white/90"
            rotationEnd="bottom center"
            wordAnimationEnd="bottom 25%"
          >
